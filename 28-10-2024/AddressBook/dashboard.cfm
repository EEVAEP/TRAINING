...
<cfif structKeyExists(form, "contactId") AND form.contactId neq "">
	<cfset variables.contactEditUser = application.userService.validateContact(form.title, 
									form.firstName,
									form.lastName, 
									form.gender, 
									form.dob, 
...
<cfif structKeyExists(variables, "contactEditUser") AND arrayLen(contactEditUser) EQ 0>
	<cfset contactEditUser = application.userService.EditContact(form.title, 
									form.firstName,
									form.lastName, 
									form.gender, 
									form.dob, 
...
<html lang="en">
	...
	<body>
			...
			<cfif structKeyExists(variables, "contactEditUser") AND arrayLen(contactEditUser) GT 0>
				<cfoutput>
					<cfloop array="#contactEditUser#" index="error">
                    				<span class="error">#error#</span>
                			</cfloop>
            			</cfoutput>
