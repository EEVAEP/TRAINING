...
<html lang="en">
	...
	<body>
			...
			<div class="modal fade" 
				...
				aria-hidden="true">
    				<div class="modal-dialog">
        				<div class="modal-content">
            					<div class="modal-header">
                					<h5 class="modal-title mx-auto d-block" id="excelUploadModal">UPLOAD YOUR TEMPLATE</h5>
                					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            					</div>
								...
								<div>
									<button id="uploadFileBtn" type="submit" name="UploadSubmit" class="btn btn-primary w-50  mt-3 mb-4">Upload</button>
		...
		<script src="./js/excelScript.js"></script>
