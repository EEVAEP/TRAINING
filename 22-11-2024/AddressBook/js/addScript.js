	...
	$(document).on('click', '.view', function() {
		...
		$.ajax({
			...
			success:function(response){
				...
				$('#viewPhoto').attr('src',`./${dataRow[6]}`);
				$('#viewName').text(`${dataRow[12]} ${dataRow[2]} ${dataRow[3]}`);
				$('#viewFirstName').text(`${dataRow[2]}`);
				$('#viewLastName').text(`${dataRow[3]}`);
				$('#viewDob').text(formattedDob);
				$('#viewAddress').text(`${dataRow[7]}`);
				$('#viewStreet').text(`${dataRow[8]}`);
				$('#viewPincode').text(`${dataRow[9]}`);
				$('#viewEmail').text(`${dataRow[10]}`);
				$('#viewPhone').text(`${dataRow[11]}`);	
				$('#viewTitle').text(`${dataRow[12]}`);
				$('#viewGender').text(`${dataRow[13]}`);
