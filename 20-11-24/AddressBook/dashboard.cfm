	...
	<body>
    		<div class="container-fluid h-100 d-flex flex-column">
        		...
        		<div class="row mt-4 pt-4 align-items-start">
					...
					<button class="btn btn-primary w-100 mb-4" onclick="document.getElementById('excelFile').click()">Upload Excel</button>
  					<input type="file" id="excelFile" style="display:none;" accept=".xlsx" onchange="uploadExcelFile()">
				...
				<div class="col-lg-9 col-md-8 p-4 mt-2">
           				<nav class="navbar navbar-expand-lg navbar-light custom-background">
    						<div class="container-fluid">
								...
								<button class="btn btn-primary me-2" onclick="window.location.href='excelPlainTemplate.cfm'">Plain Template</button>
		...
		<script src="./js/excelPlain.js"></script>
