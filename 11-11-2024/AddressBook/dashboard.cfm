...
<cftry>
	...
	<cfloop from="1" to="#qryPages.recordCount#" index="i">
		<cfset local.encryptedId = encrypt(qryPages.idcontact[i], application.encryptionKey, "AES", "Hex")>

		<cfset hobbyIdsArray = ListToArray(qryPages.hobby_ids, ",")>
		<cfset hobbyNamesArray = ListToArray(qryPages.hobby_names, ",")>
		<cfset hobbiesArray = []>
				...
				<div class="col-lg-9 col-md-8 p-4 mt-2">
           				<nav class="navbar navbar-expand-lg navbar-light custom-background">
                			...
                			<div class="table-responsive mt-3">
									...
									<cfset local.encryptedId = encrypt(qryPages.idcontact, application.encryptionKey, "AES", "Hex")>
    									<tr data-id="#local.encryptedId#">
        									<td>
        				...
        				<div class="modal-content">
							...
							<h5 class="modal-title mx-auto d-block" id="createContactModalLabel">CREATE CONTACT</h5>
            					...
            					<div class="modal-body">
                					...
                					<form method="post" id="contactForm"action="dashboard.cfm" enctype="multipart/form-data">
								<div class="row">
								...
								<div>
									...
									<button id="saveContactBtn" name="submit" class="btn btn-primary mt-3 mb-4 mx-auto col-md-5">Save Contact</button>
